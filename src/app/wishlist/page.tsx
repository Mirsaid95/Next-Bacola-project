...
export default function WishlistPage() {
    ...
    useEffect(() => {
        // localStorage dan wishlist ma'lumotlarini olish
        const loadWishlistProducts = async () => {
            try {
                ...
                if (savedWishlist) {
                    ...
                    // Faqat wishlistdagi mahsulotlarni filterlash
    ...
    const handleAddSelectedToCart = () => {
        ...
        // Qo'shilgandan so'ng notification ko'rsatish mumkin
                ...
                <div className="p-4 border-t">
                    ...
                    <div className="flex items-center justify-end gap-4 mt-6 pt-6 border-t">
                        ...
                        <div className="flex gap-3">
                            ...
                            <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-[#ea4335] text-white hover:opacity-90">
                            ...
                            <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-[#bd081c] text-white hover:opacity-90">
