            ...
            <section className="container mx-auto pt-10 pb-20">
                <div className="grid grid-cols-1 gap-6">
                    <div className="flex flex-col gap-2 items-center justify-center">
                        <h1 className="text-[48px] font-simebold text-[#202435] text-center">Get In Touch</h1>
                    ...
                    <div className="flex flex-col gap-4 items-center justify-center md:flex-row">
                        <Link href="https://maps.google.com/?q=Wall+Street,New+York,NY" className="w-[340px] h-[210px] bg-[#f3f3f6] rounded-md p-4 text-center flex flex-col gap-2 items-center justify-center">
                            ...
                            <h3 className="text-[18px] font-normal text-[#202435]">Wall Street, New York</h3>
                            <p className="text-[14px] font-normal text-[#202435]">Lorem ipsum dolar site amet discont</p>
                        </Link>
                        <Link href="tel:+02-1234-567-88" className="w-[340px] h-[210px] bg-[#f3f3f6] rounded-md p-4 text-center flex flex-col gap-2 items-center justify-center">
                        ...
                        <Link href="mailto:info@example.com" className="w-[340px] h-[210px] bg-[#f3f3f6] rounded-md p-4 text-center flex flex-col gap-2 items-center justify-center">
            ...
            <section className="container mx-auto pb-20">
                <div className="container mx-auto flex flex-col gap-8 send-us-container bg-white rounded-lg shadow-[0_0_60px_-15px_rgba(0,0,0,0.1)] h-[1000px]">
                    <div className="flex flex-col items-center justify-center border-b border-gray-200 pb-10 pt-10">
                        <h1 className="text-[45px] font-medium text-[#202435] text-center">Send Us</h1>
                        <p className="text-[16px] font-normal text-[#202435] text-center max-w-[800px] mt-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Expedita quaerat unde quam dolor culpa veritatis inventore, aut commodi eum veniam vel.</p>
                    </div>
