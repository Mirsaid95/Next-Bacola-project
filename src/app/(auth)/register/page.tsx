                ...
                <div className="max-w-[500px] mx-auto bg-white p-8 rounded border h-[700px]">
                    ...
                    >
                        <div className="flex justify-center gap-8 mb-8">
                            <Link href="/login" className="text-[20px] font-normal text-gray-400 pb-1">
                                LOGIN
                            </Link>
                            <Link href="/register" className="text-[20px] font-semibold text-gray-900 border-b-2 border-gray-900 pb-1">
                                REGISTER
                            </Link>
                        </div>
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <p className="text-[15px] text-gray-600 leading-relaxed">
                                ...
                                <Link href="/privacy-policy" className="text-[#2bbef9] hover:text-[#233a95] transition-colors">
                                    Privacy policy
                                </Link>
                                .
                            </p>
