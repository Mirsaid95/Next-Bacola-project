                ...
                <div className="max-w-[500px] mx-auto bg-white p-8 rounded border h-[650px]">
                    ...
                    >
                        <div className="flex justify-center gap-8 mb-8">
                            <Link href="/login" className="text-[20px] font-semibold text-gray-900 border-b-2 border-gray-900 pb-1">
                                LOGIN
                            </Link>
                            <Link href="/register" className="text-[20px] font-normal text-gray-400 pb-1">
                                REGISTER
                            </Link>
                        </div>
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <div className="flex items-center gap-2">
                                <Checkbox id="remember" className="rounded-none data-[state=checked]:bg-[#233a95] data-[state=checked]:border-[#233a95]" />
                                <label 
                                    htmlFor="remember" 
