      ...
      <section>
        <div className="relative pt-5">
          ...
          <div className="w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
            <h1 className="text-[26px] font-bold mb-2 md:text-[36px] lg:text-[50px] xl:text-[70px]">About for Bacola</h1>
            <p className="text-[18px] font-normal md:text-[18px] lg:text-[22px] xl:text-[26px]">WE CAN DO MORE FOR YOU</p>
          </div>
        </div>
        <p className="container mx-auto text-[14px] font-normal pt-10">In nec purus eget neque accumsan finibus. Duis condimentum elit ut libero commodo iaculis. Donec augue diam, tristique et ultricies nec, consectetur quis enim. Nullam id rutrum ex. Aliquam a lectus id lacus rhoncus dapibus non ac justo. Vivamus lacinia vestibulum metus in dapibus. Vestibulum sit amet sollicitudin enim. Ut id interdum turpis. Curabitur porta auctor quam, pretium facilisis nisl. Pellentesque efficitur elit ante, vel vulputate tortor blandit nec.</p>
      </section>
      ...
      <section>
        <div className="container mx-auto pt-10 pb-20">
          <div className="flex flex-col gap-10 w-full">
            ...
            <p className=" text-[#202435] text-[14px] font-normal font-Inter xl:pl-10">In nec purus eget neque accumsan finibus. Duis condimentum elit ut libero commodo iaculis. Donec augue diam, tristique et ultricies nec, consectetur quis enim. Nullam id rutrum ex. Aliquam a lectus id lacus rhoncus dapibus non ac justo. Vivamus lacinia vestibulum metus in dapibus. Vestibulum sit amet sollicitudin enim. Ut id interdum turpis. Curabitur porta auctor quam, pretium facilisis nisl. Pellentesque efficitur elit ante, vel vulputate tortor blandit nec.</p>
          </div>
          ...
          <div className="relative flex flex-col gap-10">
            <div className="relative flex flex-col items-center gap-5 w-full pt-10 xl:flex-row xl:gap-10">
              <div className="w-full lg:flex lg:items-start">
                <Image src="https://klbtheme.com/bacola/wp-content/uploads/2021/08/about-people.jpg" alt="About Us Image" width={500} height={500} className="h-full xl:w-[100%]" />
              </div>
              <div className="w-[100%] flex flex-col gap-10 lg:gap-4">
                <h5 className="text-[18px] text-[#202435] font-normal xl:text-[22px]">Rachel Leonard - Bacola CEO</h5>
                <h1 className="text-[30px] text-[#202435] font-bold xl:text-[36px]">Duis convallis luctus pretium. Pellentesque habitant morbi</h1>
                <p className="text-[14px] text-[#202435] font-normal xl:text-[16px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.</p>
