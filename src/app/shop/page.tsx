...
export default function ShopPage() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const response = await fetch(`http://localhost:8000/product/?offset=${offset}&limit=${productsPerPage}`);
        ...
        <section>
            ...
            <div className="container mx-auto px-4 py-8 flex gap-8">
                ...
                `}>
                    ...
                    <div className="mb-12">
                        <h2 className="text-lg font-bold mb-4 text-[#2B2B2B]">PRODUCT CATEGORIES</h2>
                    ...
                    <div className="mb-12">
                        <h2 className="text-lg font-bold mb-4 text-[#2B2B2B]">FILTER BY PRICE</h2>
                        <div className="px-1">
                            <Slider
                                defaultValue={[0, 70]}
                                max={70}
                            ...
                            <Button 
                                className="w-full bg-[#2B2B2B] hover:bg-[#000000] text-white"
                            >
                                FILTER
                            </Button>
                        </div>
                    ...
                    <div className="mb-12">
                        <h2 className="text-lg font-bold mb-4 text-[#2B2B2B]">PRODUCT STATUS</h2>
                        <div className="space-y-3">
                    ...
                    <div className='left-sidebar-gif'>
                            <Image src="https://klbtheme.com/bacola/wp-content/uploads/2021/05/sidebar-banner.gif" alt="Shop Banner" width={280} height={280} />
                    </div>
                </div>
