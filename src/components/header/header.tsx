      ...
      <header>
        <div className="border-b">
          <div className="p-3 bg-[#233a95] w-[100%] h-[70px] md:h-[40px] flex items-center justify-center">
            <div>
              <h1 className="text-white text-[16px] text-center">
                Due to the{" "}
                <span className="text-[#ff0000] font-bold">COVID 19</span>{" "}
          ...
          <div className="hidden xl:flex flex-col pt-2">
                ...
                {page
                  ...
                  .map((item) => (
                    <li key={item.id}>
                      <Link
                        href={item.path}
                        className="text-[16px] text-[#3E445A] hover:text-blue-500 transition-colors"
                      >
                        {item.title}
                      </Link>
                    </li>
            ...
            <div className="container flex items-center pt-3 pb-2 gap-4 justify-end w-[100%]">
              <div className="flex items-center gap-2">
                <SecurityIcons />
                <h5 className="text-[16px] text-[#3E445A]">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+ 0020 500" className="text-[#2bbef9] font-bold">
                  + 0020 500
                </a>
              </div>
          ...
          <div className="fixed bottom-0 left-0 z-50 w-full h-14 bg-white border-t border-gray-200 xl:hidden">
            <div className="grid h-full max-w-lg grid-cols-4 mx-auto">
              ...
              >
                ...
                <span className="text-xs text-gray-500 group-hover:text-[#2bbef9]">
                  Store
                </span>
              </Link>
              <Link
      ...
      <nav>
        <div className="container mx-auto w-full flex items-center justify-between xxl:gap-[100px] shadow-[0_1px_10px_rgba(0,0,0,0.15)] md:shadow-none h-[70px] pt-2">
          <Sheet>
            ...
            <SheetContent
              side="left"
              className="w-full sm:max-w-[400px] p-0 block md:hidden"
            >
              ...
              <div className="px-4 py-6 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col gap-4 border-t pt-4">
                    <div className="flex items-center gap-2">
                      <p className="text-[16px] text-[#3E445A]">
                        Copyright © 2024 Bacola Market. All rights reserved.
                        Powered by <span className="text-[#2bbef9]">Next</span>
                      </p>
                    </div>
                  </div>
          ...
          <form className="hidden md:flex outline-none items-center w-full h-[60px] bg-[#f3f4f6] rounded-md md:w-[40%] lg:w-[40%] xl:w-[50%]">
            ...
            >
              <Search
                className="w-[30px] h-[30px] text-[#3E445A]"
                strokeWidth={1.8}
              />
            </Button>
          </form>
          ...
          <div className="flex items-center gap-8">
            <Link href="/login" className="user-accaunt hidden md:flex">
              ...
              >
                <div className="flex flex-col">
                  <span className="text-[13px] text-gray-500 hidden md:hidden lg:block text:block">
                    Sign in
                  </span>
                </div>
            ...
            <div className="mobile-items flex items-center">
              ...
              >
                <Button
                  variant="ghost"
                  className="flex items-center gap-4 p-0 hover:bg-transparent"
                >
                  <div className="hidden tab:flex">
                    <p className="text-[15px] font-medium text-[#3E445A]">
          ...
          <div className="container mx-auto">
            <div className="flex items-center justify-between py-4 gap-2">
              <Popover>
                ...
                <PopoverContent
                  className="w-[280px] p-0 mt-[26px] bg-white"
                  align="start"
                  side="bottom"
                >
                  <div className="py-2">
              ...
              <div className="flex items-center gap-8 lg:gap-4">
                <Link
                  ...
                  className={`flex items-center gap-2 text-[15px] lg:text-[12px] font-medium lg:font-normal text-gray-700 hover:bg-[#f0faff] hover:text-[#2bbef9] transition-colors group h-[45px] px-2 rounded-full  justify-center ${
                    pathname === "/meats-and-seafood"
                      ? "bg-[#f0faff] text-[#2bbef9]"
                      : ""
                  }`}
                >
                  <div
                    className={`w-10 h-10 lg:w-8 lg:h-8 xxl:w-10 xxl:h-10 bg-[#F3F5F9] rounded-full flex items-center justify-center group-hover:bg-[#f0faff] ${
                      pathname === "/meats-and-seafood" ? "text-[#2bbef9]" : ""
                    }`}
                  >
                ...
                <Link
                  href="/bakery"
                  className={`flex items-center gap-2 text-[15px] lg:text-[12px] font-medium lg:font-normal text-gray-700 hover:bg-[#f0faff] hover:text-[#2bbef9] transition-colors group h-[45px] px-2 rounded-full  justify-center ${
                    pathname === "/bakery" ? "bg-[#f0faff] text-[#2bbef9]" : ""
                  }`}
                >
                  <div
                    className={`w-10 h-10 lg:w-8 lg:h-8 xxl:w-10 xxl:h-10 bg-[#F3F5F9] rounded-full flex items-center justify-center group-hover:bg-[#f0faff] ${
                      pathname === "/bakery" ? "text-[#2bbef9]" : ""
                    }`}
                  >
                    <Cookie className="w-5 h-5 lg:w-4 lg:h-4 text-[#2bbef9] xxl:w-6 xxl:h-6" />
                  </div>
                  <span
                    className={pathname === "/bakery" ? "text-[#2bbef9]" : ""}
                  >
                    BAKERY
                  </span>
                </Link>
                <Link
                  href="/beverages"
                  className={`gap-2 text-[15px] lg:text-[12px] font-medium lg:font-normal text-gray-700 hover:bg-[#f0faff] hover:text-[#2bbef9] transition-colors group h-[45px] px-2 rounded-full flex items-center justify-center ${
                    pathname === "/beverages"
                      ? "bg-[#f0faff] text-[#2bbef9]"
                      : ""
                  }`}
                >
                  <div
                    className={`w-10 h-10 lg:w-8 lg:h-8 xxl:w-10 xxl:h-10 bg-[#F3F5F9] rounded-full flex items-center justify-center group-hover:bg-[#f0faff] ${
                      pathname === "/beverages" ? "text-[#2bbef9]" : ""
                    }`}
                  >
                ...
                <Link
                  href="/blog"
                  className={`gap-2 text-[15px] lg:text-[12px] font-medium lg:font-normal text-gray-700 hover:bg-[#f0faff] hover:text-[#2bbef9] transition-colors group h-[45px] px-2 rounded-full flex items-center justify-center ${
                    pathname === "/blog" ? "bg-[#f0faff] text-[#2bbef9]" : ""
                  }`}
                >
                  <div
                    className={`w-10 h-10 lg:w-8 lg:h-8 xxl:w-10 xxl:h-10 bg-[#F3F5F9] rounded-full flex items-center justify-center group-hover:bg-[#f0faff] ${
                      pathname === "/blog" ? "text-[#2bbef9]" : ""
                    }`}
                  >
                    <BookOpen className="w-5 h-5 lg:w-4 lg:h-4 text-[#2bbef9] xxl:w-6 xxl:h-6" />
                  </div>
                  <span
                    className={pathname === "/blog" ? "text-[#2bbef9]" : ""}
                  >
                    BLOG
                  </span>
                </Link>
                <Link
                  href="/contact"
                  className={`gap-2 text-[15px] lg:text-[12px] font-medium lg:font-normal text-gray-700 hover:bg-[#f0faff] hover:text-[#2bbef9] transition-colors group h-[45px] px-2 rounded-full flex items-center justify-center ${
                    pathname === "/contact" ? "bg-[#f0faff] text-[#2bbef9]" : ""
                  }`}
                >
                  <div
                    className={`w-10 h-10 lg:w-8 lg:h-8 xxl:w-10 xxl:h-10 bg-[#F3F5F9] rounded-full flex items-center justify-center group-hover:bg-[#f0faff] ${
                      pathname === "/contact" ? "text-[#2bbef9]" : ""
                    }`}
                  >
                    <PhoneCall className="w-5 h-5 lg:w-4 lg:h-4 text-[#2bbef9] xxl:w-6 xxl:h-6" />
                  </div>
                  <span
                    className={pathname === "/contact" ? "text-[#2bbef9]" : ""}
                  >
                    CONTACT
                  </span>
                </Link>
